import './App.css'
import { ThemeMode } from './Components/contextApi/ThemeMode';
    ...
    <ThemeMode>
      ...
      {/* <Navbar /> */}
        ...
        pattern-size-6 pattern-opacity-20"></div>
                ...
                <div className="absolute  bottom-8 right-40 w-72 h-72 bg-purple-300 z-10  rounded-full mix-blend-overlay filter blur-xl opacity-40 animation-delay-2000 animate-blob">
                </div>
                ...
                <div className="absolute  xs:bottom-2/4   md:top:1/4 right-0  w-72 h-72 bg-white z-10  rounded-full  mix-blend-overlay filter blur-xl opacity-40 animation-delay-2000 animate-blob">
                </div>
